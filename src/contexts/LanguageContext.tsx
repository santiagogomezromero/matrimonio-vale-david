...
const translations = {
  es: {
    ...
    'faq.q4.question': '¿Cuál es el código de vestimenta?',
    'faq.q4.answer': 'Para el viernes 1 de mayo la vestimenta es casual. La paleta de colores para ese día: blancos, beiges, cremas y marrones. La temperatura suele ser de 21 °C durante el día y de 7 °C durante la noche.\n\nPara el día en la laguna el 2 de mayo, el código es Sport Casual (Jeans). La temperatura podría oscilar entre los 18 °C hasta 7 °C.\n\nAquí en el Valle Sagrado muchos de los caminos no están pavimentados, a menudo son de tierra y rocosos. Por lo que las botas o el calzado cerrado y abrigado son las mejores opciones. Por favor, no tacones.',
  ...
  en: {
    ...
    'faq.q4.question': 'What is the dress code?',
    'faq.q4.answer': 'For Friday, May 1st, the dress code is casual. The color palette for that day includes whites, beiges, creams, and browns. The temperature is usually around 69°F during the day and 45°F at night.\n\nFor the day at the lagoon on May 2nd, the dress code is smart casual (jeans). The temperature could range from 65°F to 45°F.\n\nHere in the Sacred Valley, many paths are unpaved, often dirt and rocky. Close-toed warm shoes are the best option. High heels are not recommended.',
