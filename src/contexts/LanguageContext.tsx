...
const translations = {
  es: {
    ...
    'faq.q1.answer': 'Ciudadanos estadounidenses no necesitan visa para ingresar a Perú por turismo (estancias de hasta 90 días). Verifica los requisitos específicos para tu país de origen.',
    'faq.q2.question': '¿Qué hay de la altitud?',
    'faq.q2.answer': 'Cusco está a más de 2,900 metros sobre el nivel del mar. Recomendamos llegar un día antes para aclimatarse, beber mucha agua, evitar comidas pesadas y alcohol las primeras horas, y considerar té de coca. Consulta con tu médico si tienes condiciones preexistentes.',
    'faq.q3.question': '¿Pueden asistir niños?',
    'faq.q3.answer': 'Las invitaciones serán específicas y les pedimos que solo traigan a los niños que aparecen en su invitación.',
    ...
    'faq.q8.answer': 'Incluiremos cervezas, vinos y bebidas no alcohólicas en ambos días de celebración.',
    ...
    'story.vale.text': 'Nos conocimos en abril del 2022 en Cusco. Él acababa de mudarse desde Washington DC y yo llevaba ya un par de años viviendo acá. Yo estaba buscando casa para alquilar en un grupo de Facebook y mi mejor amiga me contactó con David que era el inquilino actual de la casa que estaba buscando. Ese día nos conocimos y desde entonces no dejamos de vernos.\n\nMe enamoré de su manera de ver la vida, de su curiosidad insaciable y de cómo me hacía reír. David me mostró una forma distinta de vivir: más presente, más aventurera, más auténtica.\n\nEn agosto del 2023 empezamos a convivir y fue entonces que supe con certeza que era con quien quería pasar mi vida. Nos complementamos perfectamente: yo lo anclo cuando su mente vuela muy lejos, y él me impulsa a soñar más grande de lo que me atrevo.',
    'story.david.title': 'La historia de David',
    'story.david.text': 'Después de meses planeando mi mudanza a Perú, finalmente llegué a Cusco. Estaba emocionado pero también nervioso – dejé atrás 15 años en Washington DC para empezar una nueva vida en un país que apenas conocía.\n\nUnas semanas después de llegar, conocí a Vale. Me cautivó inmediatamente su energía, su inteligencia y esa sonrisa que ilumina cualquier espacio. Pero más que eso, me encantó lo fácil que era estar con ella.\n\nVale me ha enseñado tanto sobre Perú, sobre la vida, sobre mí mismo. Ella me inspira a ser mejor cada día. Cuando le propuse matrimonio en Japón, ella dijo que sí, y supe que había encontrado a mi compañera de vida perfecta.',
  ...
  en: {
    ...
    'faq.q1.answer': 'U.S. citizens do not need a visa to enter Peru for tourism (stays up to 90 days). Check specific requirements for your country of origin.',
    'faq.q2.question': 'What about the altitude?',
    'faq.q2.answer': 'Cusco is at over 2,900 meters above sea level. We recommend arriving a day early to acclimatize, drinking plenty of water, avoiding heavy meals and alcohol the first hours, and considering coca tea. Consult your doctor if you have pre-existing conditions.',
    'faq.q3.question': 'Can children attend?',
    'faq.q3.answer': 'Invitations will be specific, and we ask that you only bring the children named on your invitation.',
    ...
    'faq.q8.answer': 'We will include beers, wines, and non-alcoholic beverages on both celebration days.',
    ...
    'story.vale.text': 'We met in April 2022 in Cusco. He had just moved from Washington DC and I had already been living there for a couple of years. I was looking for a house to rent on a Facebook group and my best friend connected me with David, the current tenant of the house I was looking for. That day we met, and since then, we haven\'t stopped seeing each other.\n\nI fell in love with his way of seeing life, his insatiable curiosity and how he made me laugh. David showed me a different way of living: more present, more adventurous, more authentic.\n\nIn August 2023 we started living together and that\'s when I knew for sure he was who I wanted to spend my life with. We complement each other perfectly: I anchor him when his mind flies too far, and he pushes me to dream bigger than I dare.',
    'story.david.title': 'David\'s Story',
    'story.david.text': 'After months planning my move to Peru, I finally arrived in Cusco. I was excited but also nervous – I left behind 15 years in Washington DC to start a new life in a country I barely knew.\n\nA few weeks after arriving, I met Vale. I was immediately captivated by her energy, her intelligence and that smile that lights up any space. But more than that, I loved how easy it was to be with her.\n\nVale has taught me so much about Peru, about life, about myself. She inspires me to be better every day. When I proposed to her in Japan, she said yes, and I knew I had found my perfect life partner.',
